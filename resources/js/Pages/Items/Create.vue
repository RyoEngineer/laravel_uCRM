                            ...
                            <form @submit.prevent="submit">
                                <div class="container px-5 py-6 mx-auto">
                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="p-2 w-full">
                                            <button type="submit" :disabled="form.processing" class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">商品登録</button>
                                        </div>
                                    </div>
                                    </div>
                                </div>
