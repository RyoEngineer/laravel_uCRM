                            ...
                            <form @submit.prevent="updateItems(form.id)">
                                <div class="container px-5 py-6 mx-auto">
                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="relative">
                                            <InputLabel for="name" class="leading-7 text-sm text-gray-600">商品名</InputLabel>
                                        ...
                                        <div class="p-2 w-full">
                                        <div class="relative">
                                            <InputLabel for="price" class="leading-7 text-sm text-gray-600">価格</InputLabel>
                                            <TextInput  type="number" id="price" name="price" v-model = "form.price" 
                                            class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none 
                                            text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                                        ...
                                        <div class="p-2 w-full">
                                        <div class="relative">
                                            <InputLabel for="is_selling" class="leading-7 text-sm text-gray-600">ステータス</InputLabel>
                                        ...
                                        <div class="p-2 w-full">
                                            <button type="submit" :disabled="form.processing" class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">更新</button>
                                        </div>
                                    </div>
                                    </div>
                                </div>
